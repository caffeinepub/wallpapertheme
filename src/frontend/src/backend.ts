...
import type { ExternalBlob as _ExternalBlob, ImageStored as _ImageStored, UserProfile as _UserProfile, UserProfileForFrontend as _UserProfileForFrontend, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllImages(): Promise<Array<ImageStored>> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfileFrontend(): Promise<UserProfileForFrontend | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerUserProfileFrontend();
    ...
    async getImageMetadataFrontEnd(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageMetadataFrontEnd(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImagesForUser(arg0: Principal): Promise<Array<ImageStored>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImagesForUser(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveUserProfileFrontend(arg0: UserProfileForFrontend): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveUserProfileFrontend(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ImageStored_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageStored): Promise<ImageStored> {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserProfileForFrontend]): UserProfileForFrontend | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ImageStored>): Promise<Array<ImageStored>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ImageStored_n11(_uploadFile, _downloadFile, x)));
}
